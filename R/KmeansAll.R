...
#' @usage kmeans_finder(df)
#' @param df The input data frame
#' @return  First, the total number of clusters found and the number of rows per cluster will be displayed in the console. Then, the proportion for each categorical variable within each cluster will be displayed both graphically and visually in the console.  
#' @examples
#' library(Sherlock)
#' data("flights")
